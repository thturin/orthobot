...
var fs=require('fs'); //package that comes with node to read files of images
var exec=require('child_process').exec; //package that allows node to process more than one function at a time
...
function tweetIt(){
    ...
    var rcmd = Math.floor((Math.random()*22)+1);  
        ...
        // var cmd2 = 'processing-java --sketch=`pwd`/crossPic2 --run'
        // var cmd3 = 'processing-java --sketch=`pwd`/crossPic3 --run'

        exec(cmd, processing);
        // exec(cmd2, processing);
        // exec(cmd3, processing);
        ...
        function processing (){
                ...
                var params = {
                	encoding:'base64' //how the data of the file will actually be read by the computer 
                }
